...
configure: deps ## Configure the default TeamSpeak-backed build in ./build
	...
	"$(CMAKE)" -S . -B "$(BUILD_DIR)" $(CMAKE_BASE_ARGS) \
		...
		$${TS3_XVFB:+-DTS3_XVFB=$${TS3_XVFB}} \
		$${TS3_XVFB_LIBRARY_PATH:+-DTS3_XVFB_LIBRARY_PATH=$${TS3_XVFB_LIBRARY_PATH}} \
		$${TS3_XVFB_XKB_DIR:+-DTS3_XVFB_XKB_DIR=$${TS3_XVFB_XKB_DIR}} \
		$${TS3_XVFB_BINARY_DIR:+-DTS3_XVFB_BINARY_DIR=$${TS3_XVFB_BINARY_DIR}}
